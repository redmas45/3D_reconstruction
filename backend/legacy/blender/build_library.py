"""Builds the actor asset library, run once by `backend/tools/build_actor_library.py`.
...
for _path in (str(SCRIPT_ROOT), str(PROJECT_ROOT / "backend"), str(PROJECT_ROOT / "backend" / "domain")):
