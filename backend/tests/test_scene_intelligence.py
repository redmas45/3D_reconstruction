...
class SceneIntelligenceTests(unittest.TestCase):
    ...
    def test_ambiguous_same_appearance_crossing_is_left_unmerged(self) -> None:
        """A tie is safer as two uncertain tracks than as a swapped identity."""
        detections = [
            detection(0, 0, 1, 20, 0),
            detection(2, 0, 1, 40, 0),
            detection(0, 0, 2, 120, 0),
            detection(2, 0, 2, 100, 0),
            detection(20, 1, 3, 60, 0),
            detection(22, 1, 3, 60, 0),
            detection(20, 1, 4, 60, 0),
            detection(22, 1, 4, 60, 0),
        ]
