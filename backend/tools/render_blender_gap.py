...
DEFAULT_VIDEO_PATH = PROJECT_ROOT / "backend" / "runtime" / "data" / "input" / "input_vid3.mp4"
DEFAULT_SCENE_REPORT_PATH = (
    PROJECT_ROOT / "backend" / "runtime" / "outputs" / "preview_input_vid3" / "_work" / "input_vid3" / "scene_report.json"
)
DEFAULT_OUTPUT_DIRECTORY = PROJECT_ROOT / "backend" / "runtime" / "outputs" / "blender_preview_input_vid3"
