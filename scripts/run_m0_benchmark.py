...
PROBE_SCRIPT = PROJECT_ROOT / "blender" / "bench" / "m0_probe.py"
DEFAULT_REPORT_DIRECTORY = PROJECT_ROOT / "benchmarks"
PROGRESS_MARKER = "@M0@"
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default=None, help="Report path (default: benchmarks/m0_<label>.json)")
    parser.add_argument(
        "--quick",
        action="store_true",
