...
PROTOCOL_MODULE = PROJECT_ROOT / "src" / "infrastructure" / "blender_protocol.py"
BLENDER_SERVICE_MODULE = PROJECT_ROOT / "blender" / "service.py"
WARM_SHELL_MODULE = PROJECT_ROOT / "blender" / "warm_shell.py"

PERMITTED_PROTOCOL_IMPORTS = frozenset({"json", "dataclasses", "typing"})

# Anything under src/ other than the protocol module itself is business logic.
